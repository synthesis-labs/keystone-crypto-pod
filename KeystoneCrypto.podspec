Pod::Spec.new do |s|
    ...
    s.version = '0.0.0-develop-ba588f36d0f0a6ebcb31a93029634e490323a8a3'
  ...
  s.source           = { :git => 'https://github.com/synthesis-labs/keystone-crypto-pod.git', :tag => s.version = '0.0.0-develop-ba588f36d0f0a6ebcb31a93029634e490323a8a3' }
