Pod::Spec.new do |s|
    ...
    s.version = '0.0.0-develop-939a288a392da68eecf3fb4d10d7197ca8bc13c9'
  ...
  s.source           = { :git => 'https://github.com/synthesis-labs/keystone-crypto-pod.git', :tag => s.version.to_s = '0.0.0-develop-939a288a392da68eecf3fb4d10d7197ca8bc13c9' }
